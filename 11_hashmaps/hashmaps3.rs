...
// edcreat a new HashMap named score with the team name as the key
// iterated over the result splited the result with the comma and stored the result in a vector
// extracted the team names and their respective scores 
// updated the scored goals 